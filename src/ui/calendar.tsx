...
const Calendar: React.FC<React.ComponentProps<typeof DayPicker>> = (props) => {
...
const calendarClassNames = {
  ...
  button_previous:
    "absolute left-1 top-0 z-10 flex h-7 w-7 items-center justify-center rounded-md border border-input bg-transparent p-0 opacity-50 hover:opacity-100",
  button_next:
    "absolute right-1 top-0 z-10 flex h-7 w-7 items-center justify-center rounded-md border border-input bg-transparent p-0 opacity-50 hover:opacity-100",

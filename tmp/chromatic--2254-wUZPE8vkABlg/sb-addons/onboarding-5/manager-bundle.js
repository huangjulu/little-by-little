  ...
  (() => {
    ...
    var Su,
      ...
      gr = se(() => {
        ...
        (Su = __REACT_DOM_CLIENT__),
          ({ createRoot: Wt, hydrateRoot: Tu } = __REACT_DOM_CLIENT__);
      });
    var Iu,
      Cu,
      Pu,
      ...
      br = se(() => {
        ...
        (Iu = __STORYBOOK_CORE_EVENTS__),
          ({
            ...
            FILE_COMPONENT_SEARCH_RESPONSE: Bu,
            FORCE_REMOUNT: Wu,
            FORCE_RE_RENDER: Hu,
            ...
            STORY_ERRORED: Ep,
            STORY_FINISHED: vp,
            STORY_HOT_UPDATED: Sp,
            STORY_INDEX_INVALIDATED: Tp,
            STORY_MISSING: Op,
            STORY_PREPARED: wp,
            STORY_RENDERED: _p,
            STORY_RENDER_PHASE_CHANGED: Rp,
            STORY_SPECIFIED: cn,
            STORY_THREW_EXCEPTION: Ip,
            STORY_UNCHANGED: Cp,
            TELEMETRY_ERROR: Pp,
            TOGGLE_WHATS_NEW_NOTIFICATIONS: xp,
            UNHANDLED_ERRORS_WHILE_PLAYING: Ap,
            UPDATE_GLOBALS: Np,
            UPDATE_QUERY_PARAMS: kp,
            UPDATE_STORY_ARGS: jp,
      ...
      Ut = se(() => {
        ...
        (Ff = __STORYBOOK_COMPONENTS__),
          ({
            ...
            StatelessTab: Cd,
            StatelessTabList: Pd,
            StatelessTabPanel: xd,
            StatelessTabsView: Ad,
            StorybookIcon: Nd,
            StorybookLogo: kd,
            ...
            codeCommon: th,
            components: rh,
            convertToReactAriaPlacement: nh,
            createCopyToClipboardFunction: oh,
            getStoryHref: ih,
            interleaveSeparators: ah,
            nameSpaceClassNames: sh,
            resetComponents: lh,
            useTabsState: ch,
            withReset: uh,
    ...
    var om,
      ...
      Sr = se(() => {
        ...
        G();
        q();
        (om = __STORYBOOK_ICONS__),
          ({
            AccessibilityAltIcon: im,
            AccessibilityIcon: am,
            AccessibilityIgnoredIcon: sm,
            AddIcon: lm,
            AdminIcon: cm,
            AlertAltIcon: um,
            AlertIcon: pm,
            ...
            AlignRightIcon: dm,
            AppleIcon: hm,
            ArrowBottomLeftIcon: mm,
            ArrowBottomRightIcon: ym,
            ArrowDownIcon: gm,
            ArrowLeftIcon: bm,
            ArrowRightIcon: yn,
            ArrowSolidDownIcon: Em,
            ArrowSolidLeftIcon: vm,
            ArrowSolidRightIcon: Sm,
            ArrowSolidUpIcon: Tm,
            ArrowTopLeftIcon: Om,
            ArrowTopRightIcon: wm,
            ArrowUpIcon: _m,
            AzureDevOpsIcon: Rm,
            BackIcon: Im,
            BasketIcon: Cm,
            ...
            BoldIcon: jm,
            BookIcon: Lm,
            BookmarkHollowIcon: Fm,
            BookmarkIcon: Mm,
            BottomBarIcon: Dm,
            BottomBarToggleIcon: Bm,
            BoxIcon: Wm,
            BranchIcon: Hm,
            BrowserIcon: Um,
            BugIcon: Ym,
            ...
            ChevronLeftIcon: ty,
            ChevronRightIcon: ry,
            ChevronSmallDownIcon: ny,
            ChevronSmallLeftIcon: oy,
            ChevronSmallRightIcon: iy,
            ChevronSmallUpIcon: ay,
            ChevronUpIcon: sy,
            ChromaticIcon: ly,
            ChromeIcon: cy,
            CircleHollowIcon: uy,
            ...
            PhotoDragIcon: rb,
            PhotoIcon: nb,
            PhotoStabilizeIcon: ob,
            PinAltIcon: ib,
            PinIcon: ab,
            PlayAllHollowIcon: sb,
            PlayBackIcon: lb,
            PlayHollowIcon: cb,
            PlayIcon: ub,
            PlayNextIcon: pb,
            PlusIcon: fb,
            PointerDefaultIcon: db,
            PointerHandIcon: hb,
            PowerIcon: mb,
            PrintIcon: yb,
            ProceedIcon: gb,
            ...
            SideBySideIcon: Lb,
            SidebarAltIcon: Fb,
            SidebarAltToggleIcon: Mb,
            SidebarIcon: Db,
            SidebarToggleIcon: Bb,
            SortDownIcon: Wb,
            SortUpIcon: Hb,
            SpeakerIcon: Ub,
            StackedIcon: Yb,
    ...
    function na(e, t, r, n) {
      ...
      if (typeof e == "object" && t === void 0 && r === void 0 && n === void 0)
        return e.alpha >= 1
          ...
          : "rgba(" +
              It(e.hue, e.saturation, e.lightness) +
              "," +
              e.alpha +
              ")";
      throw new de(2);
    ...
    function ca(e, t) {
      ...
      var r = He(t);
      return Ue(
        me({}, r, { lightness: ut(0, 1, r.lightness - parseFloat(e)) })
      );
    }
    function pa(e, t) {
      if (t === "transparent") return t;
    ...
    function _n(e, t, r) {
      ...
      if (!C.nullOrUndefined(i)) {
        if (C.defined(c)) {
          if (C.array(c) || C.plainObject(c)) return Wa(c, l, i);
        } else return ce(l, i);
        return !1;
      }
    ...
    function Rn(e, t, { key: r } = {}) {
      ...
      if (!Ba(n, o)) throw new TypeError("Inputs don't have length");
      return (
    ...
    function Fs(e, t) {
      ...
      if (e.size !== t.size) return !1;
      try {
        for (var a = Wr(e.entries()), s = a.next(); !s.done; s = a.next()) {
          var c = s.value;
      ...
      try {
        for (var l = Wr(e.entries()), f = l.next(); !f.done; f = l.next()) {
          var c = f.value;
    ...
    function Ms(e, t) {
      ...
      if (e.size !== t.size) return !1;
      try {
        for (var o = Wr(e.entries()), i = o.next(); !i.done; i = o.next()) {
          var a = i.value;
    ...
    function Gs(e, t) {
      ...
      var r = function (u, p) {
          try {
            return Bn(e, t, { key: u, type: "added", value: p });
          } catch {
            return !1;
          }
        },
        ...
        f = function (u, p) {
          try {
            return Bn(e, t, { key: u, type: "removed", value: p });
          } catch {
            return !1;
          }
        };
    ...
    function cl(e) {
      var t = (0, Br.default)(ll, e.options || {});
      return {
        wrapper: {
          cursor: "help",
          display: "inline-flex",
    ...
    function oc(e, t = {}) {
      ...
      (function (y) {
        ...
        let g = Cr("style");
        (g.dataset.neoconfetti = ""), (g.textContent = y), Pr(document.head, g);
      })(rc),
        e.classList.add(nc),
            ...
            "../../../node_modules/prop-types/factoryWithTypeCheckers.js"(
              ...
              t.exports = function (l, f) {
                ...
                function ne(T) {
                  ...
                  function A(U, B, L, z, M) {
                    for (var W = U[B], J = 0; J < T.length; J++)
                      if (O(W, T[J])) return null;
                      ...
                      if (!K)
                        return new b(
                          "Invalid " +
                            ...
                            L +
                            "`.\nBad object: " +
                            JSON.stringify(U[B], null, "  ") +
                            `
Valid keys: ` +
                            JSON.stringify(Object.keys(T), null, "  ")
                        );
                      var ye = K(W, V, L, z, M + "." + V, o);
                      if (ye) return ye;
                    }
                    return null;
                  }
...
`),
    ...
    G();
    q();
    var Bp = __STORYBOOK_API__,
      {
        ActiveTabs: Wp,
        Consumer: Hp,
        ManagerContext: Up,
        Provider: Yp,
        RequestResponseError: zp,
        Tag: $p,
        addons: un,
        combineParameters: Gp,
        controlOrMetaKey: qp,
        controlOrMetaSymbol: Vp,
        eventMatchesShortcut: Kp,
        eventToShortcut: Jp,
        experimental_MockUniversalStore: Xp,
        experimental_UniversalStore: Zp,
        experimental_getStatusStore: Qp,
        experimental_getTestProviderStore: ef,
        experimental_requestResponse: tf,
        experimental_useStatusStore: rf,
        experimental_useTestProviderStore: nf,
        experimental_useUniversalStore: of,
        internal_checklistStore: af,
        internal_fullStatusStore: sf,
        internal_fullTestProviderStore: lf,
        internal_universalChecklistStore: pn,
        internal_universalStatusStore: cf,
        internal_universalTestProviderStore: uf,
        isMacLike: pf,
        isShortcutTaken: ff,
        keyToSymbol: df,
        merge: hf,
        mockChannel: mf,
        optionOrAltSymbol: yf,
        shortcutMatchesShortcut: gf,
        shortcutToAriaKeyshortcuts: bf,
        shortcutToHumanString: Ef,
        types: vf,
        useAddonState: Sf,
        useArgTypes: Tf,
        useArgs: Of,

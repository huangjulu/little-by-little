try {
  (() => {
    ...
    var z8 = __STORYBOOK_COMPONENTS__,
      {
        A: $8,
        AbstractToolbar: U8,
        ActionBar: W8,
        ...
        StatelessTab: T9,
        StatelessTabList: _9,
        StatelessTabPanel: O9,
        StatelessTabsView: Z9,
        StorybookIcon: I9,
        StorybookLogo: R9,
        SyntaxHighlighter: B9,
        TT: P9,
        TabBar: V9,
        TabButton: H9,
        TabList: j9,
        ...
        codeCommon: ag,
        components: rg,
        convertToReactAriaPlacement: ig,
        createCopyToClipboardFunction: lg,
        getStoryHref: og,
        interleaveSeparators: sg,
    ...
    var Vn = __REACT_DOM__,
      {
        __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: vg,
        createPortal: Ta,
        createRoot: yg,
        findDOMNode: bg,
        flushSync: Eg,
    ...
    function dd(e, t = {}) {
      ...
      (function (g) {
        ...
        let E = qr("style");
        (E.dataset.neoconfetti = ""), (E.textContent = g), Gr(document.head, E);
      })(od),
        e.classList.add(sd),
      ...
      function k(g, E) {
        ...
        N("--xlp", Yr(_a(oo(E, 90) - 180), 0, 180, -u / 2, u / 2) + "px"),
          N("--dc", r - Hn(1e3 * it()) + "ms");
        let $ = it() < ud ? an(it() * md, 2) : 0;
        N("--x1", $),
          N("--x2", -1 * $),
          N("--x3", $),
          N("--x4", an(_a(Yr(_a(oo(E, 90) - 180), 0, 180, -1, 1)), 4)),
          N("--y1", an(it() * io, 4)),
          N("--y2", an(it() * i * (co() ? 1 : -1), 4)),
          N("--y3", io),
          N("--y4", an(pd(Yr(_a(E - 180), 0, 180, i, -i), 0), 4)),
          N("--w", (T ? s : Hn(4 * it()) + s / 2) + "px"),
          N("--h", (T ? s : Hn(2 * it()) + s) + "px");
    ...
    function ei(
      ...
      if (
        ($ && (f = -f),
        (b === -1 || isNaN(b)) &&
          ((b = Math.floor(Math.log(f) / Math.log(T))), b < 0 && (b = 0)),
        b > 8 && (k > 0 && (k += 8 - b), (b = 8)),
        u === bd)
      )
        return b;
      if (f === 0) (g[0] = 0), (S = g[1] = Xr.symbol[m][t ? mo : po][b]);
        ...
        (E = f / (r === 2 ? Math.pow(2, b * 10) : Math.pow(1e3, b))),
          t && ((E = E * 8), E >= T && b < 8 && ((E = E / T), b++));
        let le = Math.pow(10, b > 0 ? i : 0);
        (g[0] = K(E * le) / le),
          g[0] === T && b < 8 && h === -1 && ((g[0] = 1), b++),
          (S = g[1] =
            r === 10 && b === 1
              ? t
                ? xd
    ...
    var Nd = Object.create,
        ...
        var n = function (l) {
          ...
          i = function (l) {
            return l === null || typeof l == "boolean" || typeof l > "u"
              ...
              ? l.reduce(r, "")
              : n(l) &&
                Object.prototype.hasOwnProperty.call(l.props, "children")
              ? i(l.props.children)
              : "";
          };
      ...
      tl = It((e, t) => {
        ...
        function m(g, E, S) {
          return g.concat(E).map(function (T) {
            return c(T, S);
          });
        }
        function u(g, E) {
        ...
        function b(g, E, S) {
          ...
          var T = Array.isArray(E),
            N = Array.isArray(g),
            $ = T === N;
          return $ ? (T ? S.arrayMerge(g, E, S) : k(g, E, S)) : c(E, S);
        }
        b.all = function (g, E) {
          if (!Array.isArray(g))
      ...
      {
        CHROMATIC_INDEX_URL: jd,
        CHROMATIC_BASE_URL: Nr = jd || "https://www.chromatic.com",
        CHROMATIC_API_URL: Dd = `${Nr}/api`,
      } = Pe,
    ...
    function Li(e, t, n) {
      if (typeof e == "number" && typeof t == "number" && typeof n == "number")
        return Ai("#" + Dt(e) + Dt(t) + Dt(n));
      if (typeof e == "object" && t === void 0 && n === void 0)
        return Ai("#" + Dt(e.red) + Dt(e.green) + Dt(e.blue));
      throw new ct(6);
    }
    function fn(e, t, n, r) {
    ...
    function Fc(e, t) {
      ...
      var n = Rt(t);
      return Bt(
        Be({}, n, { lightness: Ln(0, 1, n.lightness - parseFloat(e)) })
      );
    }
    var Nc = je(Fc),
      Mi = Nc;
    ...
    ce({
      ...
      "&:hover, &.__hover": {
        borderColor: `${fn(j.secondary, 0.5)}`,
        transform: "translate3d(0, -3px, 0)",
        boxShadow: "rgba(0, 0, 0, 0.08) 0 3px 10px 0",
      },
      "&:active, &.__active": {
        borderColor: `${fn(j.secondary, 1)}`,
        transform: "translate3d(0, 0, 0)",
      },
    });
    ...
    var Dc = ce({
      ...
      zc = w.div(
        ...
        (e) => ({
          ...
          ...(e.isLoading && { background: j.light, filter: "grayscale(1)" }),
      ...
      Uc = w.div(
        { color: j.lightest, textAlign: "center" },
        (e) =>
          ({
            tiny: {
      ...
      Gc = w.a(
        {
          ...
          "&:hover, &:focus-visible": {
            ...
            color: Mi(0.07, j.secondary),
          },
          "&:active": {
            transform: "translateY(0)",
            color: Mi(0.1, j.secondary),
          },
          svg: {
            display: "inline-block",
            height: "1em",
        ...
        (e) => ({
          ...(e.secondary && {
            color: e.theme.base === "light" ? j.mediumdark : j.medium,
            "&:hover": { color: e.theme.base === "light" ? j.dark : j.light },
            "&:active": {
              color: e.theme.base === "light" ? j.darker : j.lighter,
            },
          }),
          ...(e.tertiary && {
            color: j.dark,
            "&:hover": { color: j.darkest },
            "&:active": { color: j.mediumdark },
          }),
          ...(e.nochrome && {
            color: "inherit",
            "&:hover, &:active": {
          ...
          ...(e.inverse && {
            color: j.lightest,
            "&:hover": { color: j.lighter },
            "&:active": { color: j.light },
          }),
        })
      ),
      Yc = w.a({}),
    ...
    var Jc = w.label((e) => ({
      ...
      Xc = w.input({
        "&::placeholder": { color: j.mediumdark },
        appearance: "none",
        border: "none",
        ...
        "&:-webkit-autofill": {
          WebkitBoxShadow: `0 0 0 3em ${j.lightest} inset`,
        },
      }),
      e5 = (e) => {
        let t = {
      ...
      t5 = w.div((e) => ({
        ...
        ".sbds-input-el": {
          position: "relative",
          ...e5(e),
          background: j.lightest,
          color: j.darkest,
          fontSize: `${H.size.s2}px`,
          lineHeight: "20px",
          padding: "10px 15px",
          boxShadow: `${j.border} 0 0 0 1px inset`,
          "&:focus": { boxShadow: `${j.secondary} 0 0 0 1px inset` },
          ...(e.appearance === "pill" && {
          ...
          ...(e.icon && {
            ...
            "&:focus + svg path": { fill: j.darker },
          }),
          ...(e.error && {
            boxShadow: `${j.red} 0 0 0 1px inset`,
            "&:focus": { boxShadow: `${j.red} 0 0 0 1px inset !important` },
          }),
        },
        "> svg": {
          ...(e.icon && {
            ...
            path: { transition: "all 150ms ease-out", fill: j.mediumdark },
          }),
          ...(e.error && {
            animation: `${jc} 700ms ease-out`,
            path: { fill: j.red },
          }),
        },
      })),
      ...
      cs = J(
        (
          ...
          let [f, g] = Te(vo({ error: r, value: y, lastErrorValue: d })),
            E = `${e}-error`;
          re(() => {
    ...
    var l5 = w.div(
        ...
        (e) => ({
          ...
          ...(e.inline && {
            ...
            width: 8,
            border: "1px solid",
            borderTopColor: j.secondary,
            borderLeftColor: j.secondary,
            borderRightColor: j.secondary,
            borderBottomColor: "transparent",
            ...(e.positive && {
              borderTopColor: j.positive,
              borderLeftColor: j.positive,
              borderRightColor: j.positive,
            }),
            ...(e.negative && {
              borderTopColor: j.red,
              borderLeftColor: j.red,
              borderRightColor: j.red,
            }),
            ...(e.neutral && {
              borderTopColor: j.dark,
              borderLeftColor: j.dark,
              borderRightColor: j.dark,
            }),
            ...(e.inverse && {
              borderTopColor: j.lightest,
              borderLeftColor: j.lightest,
              borderRightColor: j.lightest,
            }),
          }),
        })
      ),
    ...
    var jn = new Map(),
      _i = (e, t, n, r = !0) => {
        let i = () => {
            window.clearTimeout(jn.get(e)), jn.delete(e);
          },
          l = (...o) => {
            jn.has(e) ? i() : r && t(...o),
              jn.set(
                e,
                window.setTimeout(() => jn.delete(e) && t(...o), n)
              );
          };
        return (l.cancel = i), l;
      };
    ...
    var nu = w(sl)({ marginLeft: "auto" }),
      ...
      Es = class {
        ...
        get(e) {
          return (
            this.state[e] || this.channel.emit(ko, e), this.state[e]?.value
          );
        }
        set(e, t) {
                ...
                o &&
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      {
                        ariaLabel: !1,
                        href: `https://${n}.chromatic.com/builds?appId=${
                          o?.split(":")[1]
                        }`,
                        target: "_blank",
                        onClick: s,
                      ...
                      a.createElement(V.Text, null, "View project on Chromatic")
                    )
                  ),
                e &&
                  a.createElement(
    ...
    var bu = w.div(
      ...
      Cu = ({
        ...
        let [i] = Ee(nl),
          ...
          [s, d] = Te(() => !!localStorage.getItem(ho)),
          c = X(() => {
      ...
      pe = ({
        ...
        footer: t = a.createElement(
          ...
          a.createElement(We, null, a.createElement(Tr, null))
        ),
        ignoreConfig: n = !1,
      ...
      switch (B.charCodeAt(F)) {
        ...
        case 34:
          if (B.charCodeAt(F + 1) === 34 && B.charCodeAt(F + 2) === 34) {
            if (((F += 3), (t = To(Pu)) == null)) throw Ne("StringValue");
            return (
              te(),
        ...
        case 57:
          ...
          if ((c = B.charCodeAt(F)) === 46 || c === 69 || c === 101) {
            if ((t = To(Vu)) == null) throw Ne("FloatValue");
...
`),
            ...
            e.variableDefinitions &&
              ...
              (t +=
                "(" +
                _e(e.variableDefinitions, ", ", he.VariableDefinition) +
                ")")),
            e.directives &&
              e.directives.length &&
              (t += " " + _e(e.directives, " ", he.Directive));
        ...
        Field(e) {
          ...
          if (e.arguments && e.arguments.length) {
            var n = _e(e.arguments, ", ", he.Argument);
            t.length + n.length + 2 > 80
              ? (t +=
                  "(" +
                  (lt += "  ") +
                  _e(e.arguments, lt, he.Argument) +
                  (lt = lt.slice(0, -2)) +
                  ")")
              : (t += "(" + n + ")");
          }
        ...
        ListValue: (e) => "[" + _e(e.values, ", ", kt) + "]",
        ObjectValue: (e) => "{" + _e(e.fields, ", ", he.ObjectField) + "}",
...
`
                ...
                : (g = Zo((E) => {
                    ...
                    return E.stale || E.hasNext
                      ...
                      : aa([
                          S,
                          Fs(() => ((E.stale = !0), E))(
                            Or(1)(Ie((T) => T.key === f.key)(d.source))
                          ),
                        ]);
                  })(g)),
              f.kind !== "mutation"
                ? (g = hl(() => {
                    l.delete(f.key), r.delete(f.key), i.delete(f.key), (m = !1);
          ...
          var y = Ie(Boolean)(
              Fs((b) =>
                b.kind === "teardown"
                  ...
                  ? h(b)
                  : c || !m
                  ? (c || p(), o.has(b.key) || o.set(b.key, li(b, !1)), null)
                  : (function (f) {
                      return (
    ...
    var Y2 = (e, t) => {
        ...
        switch (e.code) {
          ...
          case x.invalid_union_discriminator:
            n = `Invalid discriminator value. Expected ${ae.joinValues(
              e.options
            )}`;
            break;
    ...
    var Le = class {
        ...
        static mergeObjectSync(e, t) {
          ...
          for (let r of t) {
            let { key: i, value: l } = r;
            if (i.status === "aborted" || l.status === "aborted") return D;
      ...
      D = Object.freeze({ status: "aborted" }),
    ...
    var kn = class extends Q {
      _parse(e) {
        ...
        if (Number.isNaN(e.data.getTime())) {
          let r = this._getOrReturnCtx(e);
          return L(r, { code: x.invalid_date }), D;
        }
        let t = new Le(),
          n;
        for (let r of this._def.checks)
    ...
    var da = class extends Q {
      _parse(e) {
        ...
        function r(i) {
          ...
          return L(t, { code: x.invalid_union, unionErrors: l }), D;
        }
        if (t.common.async)
          return Promise.all(
            n.map(async (i) => {
          ...
          ).then(r);
        {
          ...
          return L(t, { code: x.invalid_union, unionErrors: o }), D;
        }
      }
      get options() {
    ...
    var ca = class extends Q {
      _parse(e) {
        let { status: t, ctx: n } = this._processInputParams(e),
          r = (i, l) => {
            if (Vi(i) || Vi(l)) return D;
            let o = ji(i.value, l.value);
            return o.valid
              ? ((Hi(i) || Hi(l)) && t.dirty(),
                { status: t.value, value: o.data })
              : (L(n, { code: x.invalid_intersection_types }), D);
          };
        return n.common.async
          ? Promise.all([
          ...
          if (n.common.async) {
            ...
            return Promise.resolve().then(async () => {
              for (let s of l) {
                let d = await s.key,
                  c = await s.value;
                if (d.status === "aborted" || c.status === "aborted") return D;
            ...
            X((r) => {
              if (window.innerWidth > 800 && window.innerHeight > 800) {
                let l = (window.innerWidth - 800) / 2 + window.screenLeft,
                  o = `scrollbars=yes,width=800,height=800,top=${
...
`),
      ...
      f4 = ({ setAccessToken: e, setCreatedProjectId: t, hasProjectId: n }) => {
        let [r, i] = Ve("authenticationScreen", n ? "signin" : "welcome"),
          ...
          { uninstallAddon: d } = ys(),
          { setSubdomain: c } = al();
        De("Authentication", r.charAt(0).toUpperCase() + r.slice(1));
        let m = X(
          async (u) => {
            try {
...
`,
      ...
      E4 = ({ gitInfoError: e }) => {
        ...
        return (
          De("Errors", t ? "GitNotFound" : "GitError"),
          a.createElement(
            pe,
            { footer: null },
            a.createElement(
        ...
        return a.createElement(
          pe,
          {
            footer: a.createElement(
              ...
              a.createElement(We, { push: !0 }, a.createElement(Tr, null))
            ),
          },
          a.createElement(
            ue,
...
`)),
    ...
    function A4({ projectId: e, configFile: t }) {
      return (
        De("LinkProject", "LinkingProjectFailed"),
        a.createElement(
          pe,
          null,
          a.createElement(
...
`),
    ...
    function V4(e) {
      ...
      return (
        e?.forEach((n) => {
          ...
          if (!r) {
            t[n.story.storyId] = Di[n.status];
            return;
          }
          t[n.story.storyId] = P4(r, Di[n.status]);
        }),
    ...
    var D4 = Xs("function"),
      ...
      Xo = (e) => !$4(e) && !z4(e) && (D4(e) || typeof e == "object"),
      $4 = Xs("undefined");
    function U4(e, t) {
      let { length: n } = e;
    ...
    _.asyncGeneratorFunction = (e) => Rr(e) === "AsyncGeneratorFunction";
    _.asyncFunction = tt("AsyncFunction");
    _.bigint = Mn("bigint");
    _.boolean = (e) => e === !0 || e === !1;
    _.date = tt("Date");
    ...
    _.empty = (e) =>
      ...
      (_.map(e) && e.size === 0);
    _.error = tt("Error");
    _.function = Mn("function");
    _.generator = (e) =>
      _.iterable(e) && _.function(e.next) && _.function(e.throw);
    _.generatorFunction = tt("GeneratorFunction");
    _.instanceOf = (e, t) =>
    ...
    _.number = (e) => Mn("number")(e) && !_.nan(e);
    _.numericString = (e) =>
    ...
    _.plainFunction = tt("Function");
    _.plainObject = (e) => {
      if (Rr(e) !== "Object") return !1;
      let t = Object.getPrototypeOf(e);
      return t === null || t === Object.getPrototypeOf({});
    };
    _.primitive = (e) => _.null(e) || Q4(typeof e);
    _.promise = tt("Promise");
    _.propertyOf = (e, t, n) => {
    ...
    _.string = Mn("string");
    _.symbol = Mn("symbol");
    _.undefined = Mn("undefined");
    _.weakMap = tt("WeakMap");
    _.weakSet = tt("WeakSet");
    var I = _;
    function ep(...e) {
    ...
    function xn(e) {
      ...
      for (
        var t = Tn(10) ? document.body : null, n = e.offsetParent || null;
    ...
    function l0(e) {
      if (!e || !e.parentElement || Tn()) return document.documentElement;
    ...
    var Vp = {
        ...
        keepTogether: { order: 400, enabled: !0, fn: Tp },
    ...
    var u1 = Br,
      Wi = yt(tl()),
      jp = ["innerHTML", "ownerDocument", "style", "attributes", "nodeValue"],
      Dp = [
        "Array",
        "ArrayBuffer",
        "AsyncFunction",
    ...
    function U3(e, t) {
      ...
      let { floaterProps: s, styles: d } = e,
        c = (0, Da.default)((n = t.floaterProps) != null ? n : {}, s ?? {}),
        m = (0, Da.default)(d ?? {}, (r = t.styles) != null ? r : {}),
        u = (0, Da.default)($3, m.options || {}),
    ...
    var K3 = Y3,
      ...
      Q3 = class extends Vt {
        ...
        renderReact16() {
          if (!_t() || !Un) return null;
          let { children: e } = this.props;
          return this.node ? Ta(e, this.node) : null;
        }
        render() {
...
`),
      ...
      E7 = () => bt(Tl, "Build"),
      B0 = () => {
        let { selectedBuild: e } = bt(Tl, "Build");
      ...
      _7 = ({ children: e, localBuildProgress: t }) => (
        De("Errors", "BuildError"),
        a.createElement(
          pe,
          { footer: null },
          a.createElement(
    ...
    var V0 = ({ localBuildProgress: e, withEmoji: t = !1, ...n }) => {
        let { emoji: r, renderProgress: i } = _l[e.currentStep],
          l = i(e);
    ...
    function jr({ localBuildProgress: e }) {
      return a.createElement(
        Z7,
        { center: !0, small: !0 },
        a.createElement(
    ...
    var R7 =
      ...
      D7 = w(W)(({ theme: e }) => ({ color: e.color.darkest })),
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(jr, { localBuildProgress: e })
            )
          )
        ),
      W7 = ({ isUnchanged: e, localBuildProgress: t, ...n }) => (
        De("Onboarding", "CatchAChange"),
        n.isRunning && t
      ...
      T1 = ({ onComplete: e, onSkip: t, ranSecondBuild: n = !1 }) => {
        De("Onboarding", "CatchAChangeComplete");
        let r = Xt();
        return a.createElement(
          pe,
          { footer: null },
          ...
          a.createElement(
            ...
            t
              ? a.createElement(
                  ie,
                  null,
                  a.createElement(_1, null),
                  a.createElement(jr, { localBuildProgress: t })
                )
              : a.createElement(
                  ie,
                  null,
      ...
      J7 = ({ onCatchAChange: e, onSkip: t }) => {
        De("Onboarding", "InitialBuildComplete");
        let n = Xt();
        return a.createElement(
          pe,
          { footer: null },
      ...
      Q7 = ({
        ...
        return t?.currentStep === "error"
          ...
          ? i
            ? a.createElement(T1, { onComplete: l, onSkip: o })
        ...
        let r = ["aborted", "error"].includes(e.currentStep),
          i = Ki.map((l) => {
            let { startedAt: o, completedAt: s } = e.stepProgress[l],
              ...
              c = d && r,
              m = !o,
              u = { ..._l[l], isCurrent: d, isFailed: c, isPending: m };
            return c
              ? {
                  ...u,
    ...
    var Mh = {
      ...
      Oh = {
        ...
        time: bi({ formats: Th, defaultWidth: "full" }),
        dateTime: bi({ formats: _h, defaultWidth: "full" }),
      },
      Zh = Oh,
      Ih = {
    ...
    var Ph = {
      ...
      Uh = {
        ...
        day: qn({ values: jh, defaultWidth: "wide" }),
        dayPeriod: qn({
          values: Dh,
          defaultWidth: "wide",
          formattingValues: zh,
    ...
    function p6(e, t, n) {
      ...
      if (
        ...
        var T = v(y / 60);
        return s.formatDistance("xHours", T, c);
      } else if (g === "day") {
        var N = v(b / Fr);
    ...
    function h6(e, t) {
      return Dr(1, arguments), p6(e, Date.now(), t);
    }
    var f6 = {
      ...
      C6 = ({
        ...
        return a.createElement(
          ...
          a.createElement(
            q1,
            null,
            a.createElement(U1, null, N, a.createElement(kh, { isOutdated: e }))
          ),
          a.createElement(
            E6,
            null,
            ...
            a.createElement(
              ...
              r && T
                ? a.createElement(
                    ...
                    a.createElement(jr, { localBuildProgress: r })
                  )
                : a.createElement(
                    ie,
                    null,
          ...
          p = () => {
            ...
            return i
              ? i.currentStep === "error"
                ...
                : a.createElement(jr, { localBuildProgress: i })
              : v;
          };
        return a.createElement(
          pe,
                      ...
                      a.createElement(
                        ...
                        a.createElement(
                          ...
                          a.createElement(
                            ...
                            c ? "disable" : m ? "disableSnapshot" : "docsOnly"
                          ),
...
`),
      ...
      L6 = ({
            ...
            onReviewError: (en, ad) => {
              en instanceof Error &&
                u({
                  ...
                  content: {
                    headline: `Failed to ${
                      ad.status === "ACCEPTED" ? "accept" : "unaccept"
                    } changes`,
        ...
        re(() => {
          ...
          re(() => {
            n((en) =>
              H4(en, {
                shouldSwitchToLastBuildOnBranch: N && T,
        ...
        return k && !k.uiTests
          ? a.createElement(j4, { manageUrl: b })
          : y?.suspensionReason
          ? a.createElement(Qs, {
      ...
      _6 = ({ active: e }) => {
        ...
        if (h) return e ? a.createElement(Ti, null) : null;
        if (!y)
          return ye(
            a.createElement(M4, {
              createdProjectId: S,
      ...
      H6 = () => {
        ...
        switch (!0) {
          case !!N:
            ke = a.createElement(jt, { onClick: Se }, N);
            break;
          case E === "test-provider-state:running":
            ke = p ? _l[p.currentStep].renderProgress(p) : "Starting...";
            break;
          case !!u:
          ...
          case p?.currentStep === "complete":
            ke = p.errorCount
              ? `Encountered ${(0, wi.default)(
                  "component error",
                  p.errorCount,
                  !0
                )}`
              : i
              ? `Found ${(0, wi.default)("story", i, !0)} with ${(0,
                wi.default)("change", i)}`
    ...
    Aa.register(G, (e) => {
      Aa.add(pn, {
        ...
        render: ({ active: t }) => a.createElement(_6, { active: !!t, api: e }),
      }),
